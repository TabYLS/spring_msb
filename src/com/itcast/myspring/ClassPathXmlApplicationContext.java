...
public class ClassPathXmlApplicationContext implements BeanFactory {
	...
	public ClassPathXmlApplicationContext(String source) {
		 SAXReader reader = new SAXReader();
			...
			} catch (DocumentException | InstantiationException | IllegalAccessException | ClassNotFoundException | SecurityException | IllegalArgumentException e) {
				e.printStackTrace();
			}
	}
